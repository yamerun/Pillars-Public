...
<div class="woocommerce-variation-add-to-cart variations_button">
	...
	<button type="submit" class="single_add_to_cart_button button alt <?= esc_attr(wc_wp_theme_get_element_class_name('button')) ?>"><?= esc_html($product->single_add_to_cart_text()) ?></button>
