	...
	<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
		<thead>
			<tr>
				...
				<th class="td" scope="col" style="text-align:<?php echo esc_attr($text_align); ?>;"><?php esc_html_e('Кол-во', 'woocommerce'); ?></th>
				<th class="td" scope="col" style="text-align:<?php echo esc_attr($text_align); ?>;"><?php esc_html_e('Цена за шт.', 'woocommerce'); ?></th>
		...
		<tfoot>
			...
			if ($item_totals) {
				...
				foreach ($item_totals as $total_key => $total) {
					$i++;
					if ($total_key != 'order_total' && strpos($total_key, 'fee_') === false)
						continue;
			?>
					<tr>
