	...
	<div class="row">
		...
		<div class="col-md-4">
			<div class="block g-block">
				...
				<dl class="pillars-contact-list">
					<dt></dt>
					<dd class="pillars-contact-list__subtitle">Фактический адрес</span></dd>
					<dt class="pillars-contact-list__icon"><?= pillars_theme_get_svg_symbol('contact-icon-map') ?></dt>
					<dd class="pillars-contact-list__content">620026, Свердловская обл, <br>г. Екатеринбург, ул. Белинского 83.</dd>
				</dl>
				*/ ?>
			</div>
		</div>
